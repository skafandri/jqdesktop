    ...
    var jqWindowMethods = {
        _init: function(options){
            return this.map(function(){
                ...
                var buttonClose = $('<button class="jqdesktop-window-titlebar-button-close">Close</button>').button({icons: {primary: "ui-icon-closethick"}, text:false});
                var buttonMaximize = $('<button class="jqdesktop-window-titlebar-button-maximize">Maximize</button>').button({icons: {primary: "ui-icon-extlink"}, text:false});
                var buttonRestore = $('<button class="jqdesktop-window-titlebar-button-restore">Restore</button>').button({icons: {primary: "ui-icon-newwin"}, text:false});
                var buttonMinimize = $('<button class="jqdesktop-window-titlebar-button-minimize">Minimize</button>').button({icons: {primary: "ui-icon-minusthick"}, text:false});
