        ...
        _init: function(options){            
            ...
            if($('head#desktopcss').length==0){
                var css = '\
                    ...
                    .jqdesktop-taskbar-container{cursor:default;margin-right:2px;max-width:200px;}\n\
                    ...
                    .jqdesktop-icon-label{margin-top: 5px;text-align: center;background: none;border: none;width:120%;margin-left: -10%; color:#FFF; font-weight:normal}\n\
                    .jqdesktop-icon-selected{border: #ffffff solid thin;}\n\
                    .jqdesktop-statusbar-showdesktop{float:right;height:100%}\n\
                ';
            ...
            return this.each(function(){
                ...
                taskBar.sortable({
                    items:'.jqdesktop-taskbar-container',
                    revert: true
                });
                ...
                var buttonShowDesktop = $('<button class="jqdesktop-statusbar-showdesktop"></button>').button();
                statusBar.append(buttonShowDesktop);
                buttonShowDesktop.mouseenter(function(){
                   $('.jqdesktop-window-container:visible').css('opacity',0.1);
                }).mouseleave(function(){
                    $('.jqdesktop-window-container:visible').css('opacity',1);
                });
                buttonShowDesktop.click(function(){                    
                     $('.jqdesktop-window-container:visible').jqWindow('minimize');
                     $('.jqdesktop-window-container:visible').css('opacity',1);
                });
                $this.html('').append(taskBar,content,statusBar);
                var data = {
                    taskBar:taskBar,
                    content:content,
                    statusBar:statusBar,
